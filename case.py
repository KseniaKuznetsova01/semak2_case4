...
for i in range(len(first_words)):
    for t in range(len(list_of_words)):
        if list_of_words[t] == first_words[i] and list_of_words[t + 1] != first_words[i] and list_of_words[t + 1][
            0] not in 'QWERTYUIOPASDFGHJKLZXCVBNM':
            first_words2.append(list_of_words[t + 1])
        elif list_of_words[t] == first_words[i] and list_of_words[t + 1] != first_words[i] and list_of_words[t + 1][
            0] in 'QWERTYUIOPASDFGHJKLZXCVBNM':
            first_words2.append('.')
print(first_words2)
